...
[![GitHub release](https://img.shields.io/github/release/PhilKes/slf4j-caller-info-maven-plugin?include_prereleases=&sort=semver&color=blue)](https://github.com/PhilKes/slf4j-caller-info-maven-plugin/releases/)
